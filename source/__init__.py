...
def draw(canvas):
    ...
    canvas.draw_polygon([[x+s, y], [x+s,y+s], [x+(2*s),y+s], [x+(2*s),y]], 2, 'Black', color_puzzle_bg)
    canvas.draw_polygon([[x+(2*s),y], [x+(2*s),y+s], [x+(3*s),y+s], [x+(3*s),y]], 2, 'Black', color_puzzle_bg)

    canvas.draw_polygon([[x, y+s], [x, y+(2*s)], [x+s, y+(2*s)], [x+s, y+s]], 2, 'Black', color_puzzle_bg)
    canvas.draw_polygon([[x+s, y+s], [x+s, y+(2*s)], [x+(2*s), y+(2*s)], [x+(2*s), y+s]], 2, 'Black', color_puzzle_bg)
    canvas.draw_polygon([[x+(2*s), y+s], [x+(2*s), y+(2*s)], [x+(3*s), y+(2*s)], [x+(3*s), y+s]], 2, 'Black', color_puzzle_bg)

    canvas.draw_polygon([[x, y+(2*s)], [x, y+(3*s)], [x+s, y+(3*s)], [x+s, y+(2*s)]], 2, 'Black', color_puzzle_bg)
    canvas.draw_polygon([[x+s, y+(2*s)], [x+s, y+(3*s)], [x+(2*s), y+(3*s)], [x+(2*s), y+(2*s)]], 2, 'Black', color_puzzle_bg)
    canvas.draw_polygon([[x+(2*s), y+(2*s)], [x+(2*s), y+(3*s)], [x+(3*s), y+(3*s)], [x+(3*s), y+(2*s)]], 2, 'Black', color_puzzle_bg)
    ...
    if isTile2LockOn is True:
        canvas.draw_polygon([[v+s, w], [v+s, w+s], [v+(2*s), w+s], [v+(2*s), w]], 2, 'Black', color_input_bg)
        canvas.draw_text('2', (v_centre + s, w_centre), 40, 'Black', 'monospace')

    if isTile3LockOn is True:
        canvas.draw_polygon([[v+(2*s), w], [v+(2*s), w+s], [v+(3*s), w+s], [v+(3*s), w]], 2, 'Black', color_input_bg)
        canvas.draw_text('3', (v_centre + (2*s), w_centre), 40, 'Black', 'monospace')

    if isTile4LockOn is True:
        canvas.draw_polygon([[v, w+s], [v, w+(2*s)], [v+s, w+(2*s)], [v+s, w+s]], 2, 'Black', color_input_bg)
        canvas.draw_text('4', (v_centre, w_centre+s), 40, 'Black', 'monospace')

    if isTile5LockOn is True:
        canvas.draw_polygon([[v+s, w+s], [v+s, w+(2*s)], [v+(2*s), w+(2*s)], [v+(2*s), w+s]], 2, 'Black', color_input_bg)
        canvas.draw_text('5', (v_centre + s, w_centre + s), 40, 'Black', 'monospace')

    if isTile6LockOn is True:
        canvas.draw_polygon([[v+(2*s), w+s], [v+(2*s), w+(2*s)], [v+(3*s), w+(2*s)], [v+(3*s), w+s]], 2, 'Black', color_input_bg)
        canvas.draw_text('6', (v_centre + (2*s), w_centre + s), 40, 'Black', 'monospace')

    if isTile7LockOn is True:
        canvas.draw_polygon([[v, w+(2*s)], [v, w+(3*s)], [v+s, w+(3*s)], [v+s, w+(2*s)]], 2, 'Black', color_input_bg)
        canvas.draw_text('7', (v_centre, w_centre + (2*s)), 40, 'Black', 'monospace')

    if isTile8LockOn is True:
        canvas.draw_polygon([[v+s, w+(2*s)], [v+s, w+(3*s)], [v+(2*s), w+(3*s)], [v+(2*s), w+(2*s)]], 2, 'Black', color_input_bg)
        canvas.draw_text('8', (v_centre + s, w_centre + (2*s)), 40, 'Black', 'monospace')

    if isTile9LockOn is True:
        canvas.draw_polygon([[v+(2*s), w+(2*s)], [v+(2*s), w+(3*s)], [v+(3*s), w+(3*s)], [v+(3*s), w+(2*s)]], 2, 'Black', color_blank_tile)
